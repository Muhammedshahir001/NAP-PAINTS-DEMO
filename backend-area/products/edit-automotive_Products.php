...
if (isset($_POST['update'])) {
    ...
    if (!empty($_FILES['productImg']['name'])) {
        ...
        $sql = mysqli_prepare($con, "UPDATE automotive_Products SET productName = ?, productPrice = ? WHERE id = ?");
...
$query = mysqli_query($con, "SELECT productName, productImage, productPrice FROM automotive_Products WHERE id = '$productId'");
...
<head>
    ...
    <title>Nap Paints | Admin Panel | Update Automotive Products</title>
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-4"> Automotive Products</h5>
                            <div class="card">
                                <div class="card-body">
