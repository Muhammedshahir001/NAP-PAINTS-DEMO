...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_prepare($con, "UPDATE building_Products SET ProductImage = ? WHERE id = ?");
...
<head>
    ...
    <title>KELLCOMAN | Admin Panel | Update Building Product Image</title>
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-4">Update BuildingProduct Image</h5>
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form name="product_update_form" method="post" enctype="multipart/form-data">
                                        <?php
                                        $query = mysqli_query($con, "SELECT ProductName, ProductImage FROM building_Products WHERE id='$productId'");
                                        $cnt = 1;
                                        ...
                                        ?>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <br>
                                                <img src="../products/buildingproduct_images/<?php echo htmlentities($row['ProductImage']); ?>" width="300" height="300">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <button type="submit" name="submit" class="btn btn-primary">Submit</button> &nbsp; <a class="btn btn-success" href="../products/manage-building_products.php" role="button">Go Back</a>
                                        <?php } ?>
                                    </form>
                                </div>
                            </div>
