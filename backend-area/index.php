...
<head>
  ...
  <title>KELLCOMAN | Admin Panel | Login</title>
              ...
              <div class="card-body">
                ...
                <form method="post">
                  <div class="mb-3">
                    ...
                    <input class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" type="text" name="username">
                  </div>
                  <div class="mb-4">
                  ...
                  <div class="d-flex align-items-center justify-content-center">
                    <p class="fs-4 mb-0 fw-bold">Not Admin |</p>
                    <a class="text-primary fw-bold ms-2" href="../index.php">Go Home</a>
                  </div>
                </form>
              </div>
            </div>
