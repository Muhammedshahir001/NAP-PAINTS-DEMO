      ...
      <section class="page-header">
        ...
        <div class="container">
          <div class="page-header__inner">
            <h2>Building materials Related Items</h2>
            <div class="thm-breadcrumb__box">
              <ul class="thm-breadcrumb list-unstyled">
                <li><a href="index.html">Home</a></li>
                <li><span>/</span></li>
                <li>Building materials Related Items</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <section class="services-page-one">
        <div class="container">
            <div class="row">
                ...
                $query = "SELECT * from building_Products";
                            ...
                            <div class="services-one__single">
                                <div class="services-one__img-box">
                                    <div class="services-one__img">
                                        <a href="building.php?pid=<?php echo htmlentities($row['id']); ?>">
                                            <img src="backend-area/products/buildingproduct_images/<?php echo htmlentities($row['ProductImage']); ?>" data-echo="backend-area/products/buildingproduct_images/<?php echo htmlentities($row['ProductImage']); ?>" class="img-responsive" width="100%" height="100%" />
                                        </a>
                                    </div>
                                </div>
                                <div class="services-one__content">
                                    <h3 class="services-one__title">
                                        <a href="building.php?pid=<?php echo htmlentities($row['id']); ?>" class="smooth" title=""><?php echo htmlentities($row['ProductName']); ?></a>
                                    </h3>
                                </div>
                            </div>
                        </div>
