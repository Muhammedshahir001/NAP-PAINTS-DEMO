    ...
    <section class="services-page-one">
        <div class="container">
            <div class="row">
             ...
             $query = "SELECT *
          FROM products 
          INNER JOIN category ON products.productCategory = category.categoryName";
                            ...
                            <div class="services-one__single">
                                <div class="services-one__img-box">
                                    <div class="services-one__img">
                                        <a href="products.php?pid=<?php echo htmlentities($row['id']); ?>">
                                ...
                                <div class="services-one__content">
                                    <h3 class="services-one__title">
                                        <a href="product.php?pid=<?php echo htmlentities($row['id']); ?>" class="smooth" title=""><?php echo htmlentities($row['productName']); ?></a>
                                    </h3>
                                    <p class="services-one__category">Category: <?php echo htmlentities($row['categoryName']); ?></p>
